// Sample order data
const orders = [
    { id: 1, customer: "Venktesh Indramohan", status: "Pending", items: ["Laptop", "Phone"] },
    { id: 2, customer: "Joel GreenBlatt", status: "Shipped", items: ["Tablet", "Headphones"] },
    { id: 3, customer: "Rajesh Warkad", status: "Delivered", items: ["Camera", "Tripod"] },
    { id: 4, customer: "Santosh Thakur", status: "Out For Delivery", items: ["Shirt", "Shoes"] },
  ];
